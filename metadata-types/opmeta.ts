...
export type InputMeta = 0 | {
    ...
    parameters: {
        ...
        desc?: string;
        /**
         * @title Input Parameter Valid Length
         * @description 
         * Only used for dynamic-length arguments of a same type and determines the valid length of them, for example an opcode can have any number between 1 - 10 of same arguments: [[1, 10]] or an opcode can only have certain exact number of this type of inputs: [[2], [3], [9]], meaning it can only have 2 or 3 or 9 arguments of this type
         */
        validLength?: ([number] | [number, number])[];
        /**
